...
def _no_grad_trunc_normal_(tensor: Union[torch.Tensor, Tensor], mean: float, std: float, a: float, b: float) -> Tensor:
...
def trunc_normal_(tensor: Union[torch.Tensor, Tensor], mean: float = 0., std: float = 1., a: float = -2., b: float = 2.) -> Tensor:
